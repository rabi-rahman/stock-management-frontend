...
const Transactions = () => {
  ...
  <div className="mb-5">
    ...
    <div className="flex flex-wrap gap-3 items-center mt-4 md:flex-nowrap md:gap-4">
      <select
        className="py-2 px-4 border rounded bg-gray-200 text-gray-900 flex-shrink-0 w-full md:w-auto"
