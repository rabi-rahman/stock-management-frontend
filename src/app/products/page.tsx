...
import AddProductQuantityModal from "./AddProductQuantity";
    ...
    <div className="mx-auto pb-5 w-full">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex md:flex-row flex-col gap-4">
          <button
            className="flex items-center bg-teal-600 hover:bg-teal-400 text-gray-100 font-bold py-2 px-4 rounded"
            onClick={() => setIsAddStockModalOpen(true)}
          >
            <PlusCircleIcon className="w-5 h-5 mr-2 !text-gray-100" /> Add Stock
          </button>
